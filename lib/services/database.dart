...
class DatabaseService {
  ...
  Future updateReviewData(
      String foodID, String orderID, String review, double rating) async {
  ...
  Future<void> clearCart() async {
    try {
      ...
      DocumentSnapshot<Map<String, dynamic>> cartSnapshot = await cartCollection
          .doc(uid)
  ...
  Future<String> createOrder(String paymentmethod) async {
    ...
    final String formattedDateTime =
        DateFormat('yyyyMMddHHmm', 'en_MY').format(localDateTime);
