                              ...
                              if (nameController.text.isEmpty ||
                                ...
                                _showPanel2("Error",
                                    "Some field is empty. Please check the field an make sure all the details are filled in.");
                                      ...
                                      r'^[A-Za-z]\d{2}[A-Za-z]{2}\d{4}$')
                                  .hasMatch(matricController.text)) {
                                _showPanel2("Error",
                                    "Invalid matric number format. It should start with a letter, followed by 2 digits, 2 letters, and finally 4 digits.");
